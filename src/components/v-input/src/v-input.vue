<template>
    <div
        class="vvpay-x-input vbase-cell"
        :class="{
            'vbase-cell_warn': showWarn,
            disabled: disabled,
            'vvpay-x-input-has-right-full': hasRightFullHeightSlot
        }"
    >
        ...
        <div
            ...
            :class="
                placeholderAlign ? `vvpay-x-input-placeholder-${placeholderAlign}` : ''
            "
        >
            <input
                :id="`vvpay-x-input-${uuid}`"
                v-if="!type || type === 'text'"
                class="vbase-input"
                :maxlength="max"
        ...
        <div class="vbase-cell__ft">
            ...
            <div v-if="hasRightFullHeightSlot" class="vvpay-x-input-right-full">
...
<style lang="less">
	...
	@import "../../../styles/vbase/widget/vbase_cell/vbase_form/vbase_form_common";
	@import "../../../styles/vbase/widget/vbase_cell/vbase_form/vbase_vcode";

	.vvpay-x-input
		.vvpay-x-input-placeholder-right
		input::-webkit-input-placeholder {
		text-align: right;
	}
	.vvpay-x-input
		.vvpay-x-input-placeholder-center
		input::-webkit-input-placeholder {
		text-align: center;
	}
